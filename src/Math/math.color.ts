...
export class Color3 {
   ...
   */
  public toArray(array: number[], index: number = 0): Color3 {
    array[index] = this.r;
   ...
   * @returns the current Color3 object
   */
  public fromArray(array: ArrayLike<number>, offset: number = 0): Color3 {
  ...
  private static _BlackReadOnly = Color3.Black() as Color3;
   ...
   */
  public static FromArrayToRef(array: ArrayLike<number>, offset: number = 0, result: Color3) {
   ...
   * @returns the new Color3
   */
  public static Hermite(value1: Color3, tangent1: Color3, value2: Color3, tangent2: Color3, amount: number): Color3 {
  ...
  public static Hermite1stDerivativeToRef(
    ...
    result.r =
      (t2 - time) * 6 * value1.r +
      (3 * t2 - 4 * time + 1) * tangent1.r +
      (-t2 + time) * 6 * value2.r +
      (3 * t2 - 2 * time) * tangent2.r;
    result.g =
      (t2 - time) * 6 * value1.g +
      (3 * t2 - 4 * time + 1) * tangent1.g +
      (-t2 + time) * 6 * value2.g +
      (3 * t2 - 2 * time) * tangent2.g;
    result.b =
      (t2 - time) * 6 * value1.b +
      (3 * t2 - 4 * time + 1) * tangent1.b +
      (-t2 + time) * 6 * value2.b +
      (3 * t2 - 2 * time) * tangent2.b;
  }
   ...
   */
  public static get BlackReadOnly(): Color3 {
...
export class Color4 {
   ...
   * @returns the current Color4 object
   */
  public fromArray(array: ArrayLike<number>, offset: number = 0): Color4 {
   ...
   */
  public equals(otherColor: Color4): boolean {
    return (
      otherColor &&
      this.r === otherColor.r &&
      this.g === otherColor.g &&
   ...
   */
  public static Hermite(value1: Color4, tangent1: Color4, value2: Color4, tangent2: Color4, amount: number): Color4 {
    const squared = amount * amount;
    const cubed = amount * squared;
    const part1 = 2.0 * cubed - 3.0 * squared + 1.0;
    const part2 = -2.0 * cubed + 3.0 * squared;
  ...
  public static Hermite1stDerivativeToRef(
    ...
    result.a =
      (t2 - time) * 6 * value1.a +
      (3 * t2 - 4 * time + 1) * tangent1.a +
      (-t2 + time) * 6 * value2.a +
      (3 * t2 - 2 * time) * tangent2.a;
  }
   ...
   */
  public static FromArrayToRef(array: ArrayLike<number>, offset: number = 0, result: Color4) {
    result.r = array[offset];
    result.g = array[offset + 1];
    result.b = array[offset + 2];
